...
import { getOrder, addOrder, UpdateOrder, deleteOrder, getSingleOrder } from "../Controllers/order.controllers";
...
orderRouter.get("/getOrder", getSingleOrder);
orderRouter.get("/getSingleOrder/:userID", getOrder);
